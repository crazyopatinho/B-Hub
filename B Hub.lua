...
OrionLib:MakeNotification({
 ...
 local Sobre = Window:MakeTab({
	Name = "Sobre",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})

-- Verificamos se a aba 'Sobre' realmente existe antes de usar o AddParagraph
if Sobre then
    Sobre:AddParagraph("Sobre", "Esse Script é um microScript. O que é um microScript? É um conceito que desenvolvi onde scripts prontos residem dentro de um hub principal. Diferente de scripts comuns com várias toggles complexas, o microScript foca em botões diretos e abas organizadas para execução imediata.")
else
    warn("Erro: Não foi possível criar a aba 'Sobre'")
end
